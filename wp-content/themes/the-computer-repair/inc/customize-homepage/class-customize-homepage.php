...
if ( ! class_exists( 'The_Computer_Repair_Content_Creation' ) ) :

	/**
	 * The_Computer_Repair_Content_Creation class.
	 */
	class The_Computer_Repair_Content_Creation extends WP_Customize_Control {
		 ...
		 */
		public $type = 'the-computer-repair-content-creation';
		...
		/**
		 * The_Computer_Repair_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'The_Computer_Repair_Content_Creation' );
