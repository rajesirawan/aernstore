 ...
 */
?>
<?php if( get_theme_mod('the_computer_repair_topbar_hide_show') != ''){ ?>
	<div class="lower-bar">
		<div class="container">
			<div class="row">
			    ...
			    <div class="col-lg-2 col-md-2">
				    <?php if( get_theme_mod( 'the_computer_repair_call') != '') { ?>
	          			<p><i class="<?php echo esc_attr(get_theme_mod('the_computer_repair_phone_icon','fas fa-phone')); ?>"></i><?php echo esc_html(get_theme_mod('the_computer_repair_call',''));?></p>
	        		<?php }?>
			    </div>
			    <div class="col-lg-3 col-md-3">
				    <?php if( get_theme_mod( 'the_computer_repair_email') != '') { ?>
	          			<p><i class="<?php echo esc_attr(get_theme_mod('the_computer_repair_email_address_icon','fas fa-envelope')); ?>"></i><?php echo esc_html(get_theme_mod('the_computer_repair_email',''));?></p>
	        		<?php }?>
			    </div>
			</div>
		</div>
