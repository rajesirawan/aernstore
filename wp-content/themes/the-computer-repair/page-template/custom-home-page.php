...
<main id="maincontent" role="main">
  ...
  <section id="slider">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'the_computer_repair_slider_speed',3000)) ?>"> 
